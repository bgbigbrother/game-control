...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20062', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20062();
      });

      it('should create an instance of InlineResponse20062', function() {
        // TODO: update the code to test InlineResponse20062
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20062);
      });
