...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2007', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2007();
      });

      it('should create an instance of InlineResponse2007', function() {
        // TODO: update the code to test InlineResponse2007
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2007);
      });
