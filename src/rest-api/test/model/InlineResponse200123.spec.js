...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200123', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200123();
      });

      it('should create an instance of InlineResponse200123', function() {
        // TODO: update the code to test InlineResponse200123
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200123);
      });
