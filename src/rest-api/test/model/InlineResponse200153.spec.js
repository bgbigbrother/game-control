...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200153', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200153();
      });

      it('should create an instance of InlineResponse200153', function() {
        // TODO: update the code to test InlineResponse200153
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200153);
      });
