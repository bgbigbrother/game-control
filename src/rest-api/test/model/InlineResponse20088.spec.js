...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20088', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20088();
      });

      it('should create an instance of InlineResponse20088', function() {
        // TODO: update the code to test InlineResponse20088
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20088);
      });
