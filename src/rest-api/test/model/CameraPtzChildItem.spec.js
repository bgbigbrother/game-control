...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CameraPtzChildItem', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.CameraPtzChildItem();
      });

      it('should create an instance of CameraPtzChildItem', function() {
        // TODO: update the code to test CameraPtzChildItem
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.CameraPtzChildItem);
      });
