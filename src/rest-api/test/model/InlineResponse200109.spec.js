...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200109', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200109();
      });

      it('should create an instance of InlineResponse200109', function() {
        // TODO: update the code to test InlineResponse200109
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200109);
      });
