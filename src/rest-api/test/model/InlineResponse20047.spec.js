...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20047', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20047();
      });

      it('should create an instance of InlineResponse20047', function() {
        // TODO: update the code to test InlineResponse20047
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20047);
      });
