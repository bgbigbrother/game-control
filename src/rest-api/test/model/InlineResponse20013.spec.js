...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20013', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20013();
      });

      it('should create an instance of InlineResponse20013', function() {
        // TODO: update the code to test InlineResponse20013
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20013);
      });
