...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserDefinedEvents', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.UserDefinedEvents();
      });

      it('should create an instance of UserDefinedEvents', function() {
        // TODO: update the code to test UserDefinedEvents
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.UserDefinedEvents);
      });
