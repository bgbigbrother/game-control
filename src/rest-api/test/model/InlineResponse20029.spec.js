...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20029', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20029();
      });

      it('should create an instance of InlineResponse20029', function() {
        // TODO: update the code to test InlineResponse20029
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20029);
      });
