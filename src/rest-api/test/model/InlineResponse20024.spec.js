...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20024', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20024();
      });

      it('should create an instance of InlineResponse20024', function() {
        // TODO: update the code to test InlineResponse20024
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20024);
      });
