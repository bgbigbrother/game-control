...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20036', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20036();
      });

      it('should create an instance of InlineResponse20036', function() {
        // TODO: update the code to test InlineResponse20036
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20036);
      });
