...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20034', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20034();
      });

      it('should create an instance of InlineResponse20034', function() {
        // TODO: update the code to test InlineResponse20034
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20034);
      });
