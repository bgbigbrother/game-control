...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200157', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200157();
      });

      it('should create an instance of InlineResponse200157', function() {
        // TODO: update the code to test InlineResponse200157
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200157);
      });
