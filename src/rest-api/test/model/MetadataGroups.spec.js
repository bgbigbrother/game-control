...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetadataGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.MetadataGroups();
      });

      it('should create an instance of MetadataGroups', function() {
        // TODO: update the code to test MetadataGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.MetadataGroups);
      });
