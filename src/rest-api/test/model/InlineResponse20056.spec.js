...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20056', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20056();
      });

      it('should create an instance of InlineResponse20056', function() {
        // TODO: update the code to test InlineResponse20056
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20056);
      });
