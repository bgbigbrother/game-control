...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20043', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20043();
      });

      it('should create an instance of InlineResponse20043', function() {
        // TODO: update the code to test InlineResponse20043
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20043);
      });
