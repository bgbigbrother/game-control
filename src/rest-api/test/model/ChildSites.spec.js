...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChildSites', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.ChildSites();
      });

      it('should create an instance of ChildSites', function() {
        // TODO: update the code to test ChildSites
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.ChildSites);
      });
      ...
      it('should have the property connectionState (base name: "connectionState")', function() {
        // TODO: update the code to test the property connectionState
        expect(instance).to.have.property('connectionState');
        // expect(instance.connectionState).to.be(expectedValueLiteral);
      });
