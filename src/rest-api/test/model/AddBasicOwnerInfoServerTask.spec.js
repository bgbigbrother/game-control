...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddBasicOwnerInfoServerTask', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.AddBasicOwnerInfoServerTask();
      });

      it('should create an instance of AddBasicOwnerInfoServerTask', function() {
        // TODO: update the code to test AddBasicOwnerInfoServerTask
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.AddBasicOwnerInfoServerTask);
      });
