...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200181', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200181();
      });

      it('should create an instance of InlineResponse200181', function() {
        // TODO: update the code to test InlineResponse200181
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200181);
      });
