...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FindSaveSearchesServerTask', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.FindSaveSearchesServerTask();
      });

      it('should create an instance of FindSaveSearchesServerTask', function() {
        // TODO: update the code to test FindSaveSearchesServerTask
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.FindSaveSearchesServerTask);
      });
