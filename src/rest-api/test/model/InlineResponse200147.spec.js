...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200147', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200147();
      });

      it('should create an instance of InlineResponse200147', function() {
        // TODO: update the code to test InlineResponse200147
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200147);
      });
