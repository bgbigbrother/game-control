...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200185', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200185();
      });

      it('should create an instance of InlineResponse200185', function() {
        // TODO: update the code to test InlineResponse200185
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200185);
      });
