...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HardwareScanServerTask', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.HardwareScanServerTask();
      });

      it('should create an instance of HardwareScanServerTask', function() {
        // TODO: update the code to test HardwareScanServerTask
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.HardwareScanServerTask);
      });
