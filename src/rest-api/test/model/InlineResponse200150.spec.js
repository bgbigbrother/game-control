...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200150', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200150();
      });

      it('should create an instance of InlineResponse200150', function() {
        // TODO: update the code to test InlineResponse200150
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200150);
      });
