...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20058', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20058();
      });

      it('should create an instance of InlineResponse20058', function() {
        // TODO: update the code to test InlineResponse20058
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20058);
      });
