...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200100', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200100();
      });

      it('should create an instance of InlineResponse200100', function() {
        // TODO: update the code to test InlineResponse200100
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200100);
      });
