...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OutputGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.OutputGroups();
      });

      it('should create an instance of OutputGroups', function() {
        // TODO: update the code to test OutputGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.OutputGroups);
      });
