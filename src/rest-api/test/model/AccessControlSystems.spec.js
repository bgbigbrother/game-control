...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccessControlSystems', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.AccessControlSystems();
      });

      it('should create an instance of AccessControlSystems', function() {
        // TODO: update the code to test AccessControlSystems
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.AccessControlSystems);
      });
