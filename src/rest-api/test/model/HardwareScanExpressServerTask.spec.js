...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HardwareScanExpressServerTask', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.HardwareScanExpressServerTask();
      });

      it('should create an instance of HardwareScanExpressServerTask', function() {
        // TODO: update the code to test HardwareScanExpressServerTask
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.HardwareScanExpressServerTask);
      });
