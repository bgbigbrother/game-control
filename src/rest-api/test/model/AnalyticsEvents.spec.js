...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnalyticsEvents', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.AnalyticsEvents();
      });

      it('should create an instance of AnalyticsEvents', function() {
        // TODO: update the code to test AnalyticsEvents
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.AnalyticsEvents);
      });
