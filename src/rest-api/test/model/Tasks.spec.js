...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Tasks', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.Tasks();
      });

      it('should create an instance of Tasks', function() {
        // TODO: update the code to test Tasks
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.Tasks);
      });
