...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200183', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200183();
      });

      it('should create an instance of InlineResponse200183', function() {
        // TODO: update the code to test InlineResponse200183
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200183);
      });
