...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200164', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200164();
      });

      it('should create an instance of InlineResponse200164', function() {
        // TODO: update the code to test InlineResponse200164
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200164);
      });
