...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20060', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20060();
      });

      it('should create an instance of InlineResponse20060', function() {
        // TODO: update the code to test InlineResponse20060
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20060);
      });
