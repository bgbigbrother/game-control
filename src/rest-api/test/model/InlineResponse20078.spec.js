...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20078', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20078();
      });

      it('should create an instance of InlineResponse20078', function() {
        // TODO: update the code to test InlineResponse20078
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20078);
      });
