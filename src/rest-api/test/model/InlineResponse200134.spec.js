...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200134', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200134();
      });

      it('should create an instance of InlineResponse200134', function() {
        // TODO: update the code to test InlineResponse200134
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200134);
      });
