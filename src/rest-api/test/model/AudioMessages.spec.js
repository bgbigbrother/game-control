...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AudioMessages', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.AudioMessages();
      });

      it('should create an instance of AudioMessages', function() {
        // TODO: update the code to test AudioMessages
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.AudioMessages);
      });
