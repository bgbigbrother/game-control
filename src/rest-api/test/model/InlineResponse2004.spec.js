...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2004', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2004();
      });

      it('should create an instance of InlineResponse2004', function() {
        // TODO: update the code to test InlineResponse2004
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2004);
      });
