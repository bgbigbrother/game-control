...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200132', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200132();
      });

      it('should create an instance of InlineResponse200132', function() {
        // TODO: update the code to test InlineResponse200132
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200132);
      });
