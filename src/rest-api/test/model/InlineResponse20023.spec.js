...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20023', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20023();
      });

      it('should create an instance of InlineResponse20023', function() {
        // TODO: update the code to test InlineResponse20023
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20023);
      });
