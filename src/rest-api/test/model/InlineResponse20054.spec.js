...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20054', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20054();
      });

      it('should create an instance of InlineResponse20054', function() {
        // TODO: update the code to test InlineResponse20054
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20054);
      });
