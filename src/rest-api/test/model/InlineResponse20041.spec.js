...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20041', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20041();
      });

      it('should create an instance of InlineResponse20041', function() {
        // TODO: update the code to test InlineResponse20041
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20041);
      });
