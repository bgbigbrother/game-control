...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200175', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200175();
      });

      it('should create an instance of InlineResponse200175', function() {
        // TODO: update the code to test InlineResponse200175
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200175);
      });
