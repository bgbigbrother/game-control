...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200178', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200178();
      });

      it('should create an instance of InlineResponse200178', function() {
        // TODO: update the code to test InlineResponse200178
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200178);
      });
