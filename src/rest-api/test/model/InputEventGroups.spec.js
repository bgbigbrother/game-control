...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InputEventGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InputEventGroups();
      });

      it('should create an instance of InputEventGroups', function() {
        // TODO: update the code to test InputEventGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InputEventGroups);
      });
