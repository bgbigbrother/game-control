...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20011();
      });

      it('should create an instance of InlineResponse20011', function() {
        // TODO: update the code to test InlineResponse20011
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20011);
      });
