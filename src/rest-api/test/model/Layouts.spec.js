...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Layouts', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.Layouts();
      });

      it('should create an instance of Layouts', function() {
        // TODO: update the code to test Layouts
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.Layouts);
      });
