...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200142', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200142();
      });

      it('should create an instance of InlineResponse200142', function() {
        // TODO: update the code to test InlineResponse200142
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200142);
      });
