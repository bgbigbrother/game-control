...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20022', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20022();
      });

      it('should create an instance of InlineResponse20022', function() {
        // TODO: update the code to test InlineResponse20022
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20022);
      });
