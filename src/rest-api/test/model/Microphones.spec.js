...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Microphones', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.Microphones();
      });

      it('should create an instance of Microphones', function() {
        // TODO: update the code to test Microphones
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.Microphones);
      });
