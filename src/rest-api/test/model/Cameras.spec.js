...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Cameras', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.Cameras();
      });

      it('should create an instance of Cameras', function() {
        // TODO: update the code to test Cameras
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.Cameras);
      });
      ...
      it('should have the property recordingFramerate (base name: "recordingFramerate")', function() {
        // TODO: update the code to test the property recordingFramerate
        expect(instance).to.have.property('recordingFramerate');
        // expect(instance.recordingFramerate).to.be(expectedValueLiteral);
      });

      it('should have the property recordKeyframesOnly (base name: "recordKeyframesOnly")', function() {
        // TODO: update the code to test the property recordKeyframesOnly
        expect(instance).to.have.property('recordKeyframesOnly');
        // expect(instance.recordKeyframesOnly).to.be(expectedValueLiteral);
      });

      it('should have the property recordOnRelatedDevices (base name: "recordOnRelatedDevices")', function() {
        // TODO: update the code to test the property recordOnRelatedDevices
        expect(instance).to.have.property('recordOnRelatedDevices');
        // expect(instance.recordOnRelatedDevices).to.be(expectedValueLiteral);
      });
