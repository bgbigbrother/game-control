...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SaveSearches', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.SaveSearches();
      });

      it('should create an instance of SaveSearches', function() {
        // TODO: update the code to test SaveSearches
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.SaveSearches);
      });
