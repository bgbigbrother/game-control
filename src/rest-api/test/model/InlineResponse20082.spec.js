...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20082', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20082();
      });

      it('should create an instance of InlineResponse20082', function() {
        // TODO: update the code to test InlineResponse20082
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20082);
      });
