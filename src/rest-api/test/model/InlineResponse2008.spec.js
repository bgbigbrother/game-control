...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2008', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2008();
      });

      it('should create an instance of InlineResponse2008', function() {
        // TODO: update the code to test InlineResponse2008
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse2008);
      });
