...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200172', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200172();
      });

      it('should create an instance of InlineResponse200172', function() {
        // TODO: update the code to test InlineResponse200172
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200172);
      });
