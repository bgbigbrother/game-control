...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20084', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20084();
      });

      it('should create an instance of InlineResponse20084', function() {
        // TODO: update the code to test InlineResponse20084
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20084);
      });
