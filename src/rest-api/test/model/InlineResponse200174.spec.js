...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200174', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200174();
      });

      it('should create an instance of InlineResponse200174', function() {
        // TODO: update the code to test InlineResponse200174
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200174);
      });
