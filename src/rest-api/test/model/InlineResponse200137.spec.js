...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200137', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200137();
      });

      it('should create an instance of InlineResponse200137', function() {
        // TODO: update the code to test InlineResponse200137
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200137);
      });
