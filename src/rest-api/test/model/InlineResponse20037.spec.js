...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20037', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20037();
      });

      it('should create an instance of InlineResponse20037', function() {
        // TODO: update the code to test InlineResponse20037
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20037);
      });
