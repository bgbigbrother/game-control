...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20064', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20064();
      });

      it('should create an instance of InlineResponse20064', function() {
        // TODO: update the code to test InlineResponse20064
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20064);
      });
