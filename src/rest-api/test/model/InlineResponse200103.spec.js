...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200103', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200103();
      });

      it('should create an instance of InlineResponse200103', function() {
        // TODO: update the code to test InlineResponse200103
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200103);
      });
