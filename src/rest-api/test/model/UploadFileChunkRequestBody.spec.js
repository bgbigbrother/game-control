...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UploadFileChunkRequestBody', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.UploadFileChunkRequestBody();
      });

      it('should create an instance of UploadFileChunkRequestBody', function() {
        // TODO: update the code to test UploadFileChunkRequestBody
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.UploadFileChunkRequestBody);
      });
