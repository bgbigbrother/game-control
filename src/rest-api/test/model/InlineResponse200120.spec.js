...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200120', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200120();
      });

      it('should create an instance of InlineResponse200120', function() {
        // TODO: update the code to test InlineResponse200120
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200120);
      });
