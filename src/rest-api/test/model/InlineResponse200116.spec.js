...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200116', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200116();
      });

      it('should create an instance of InlineResponse200116', function() {
        // TODO: update the code to test InlineResponse200116
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200116);
      });
