...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20026', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20026();
      });

      it('should create an instance of InlineResponse20026', function() {
        // TODO: update the code to test InlineResponse20026
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20026);
      });
