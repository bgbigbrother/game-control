...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MicrophoneGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.MicrophoneGroups();
      });

      it('should create an instance of MicrophoneGroups', function() {
        // TODO: update the code to test MicrophoneGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.MicrophoneGroups);
      });
