...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200107', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200107();
      });

      it('should create an instance of InlineResponse200107', function() {
        // TODO: update the code to test InlineResponse200107
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200107);
      });
