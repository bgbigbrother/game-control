...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200104', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200104();
      });

      it('should create an instance of InlineResponse200104', function() {
        // TODO: update the code to test InlineResponse200104
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200104);
      });
