...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200171', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200171();
      });

      it('should create an instance of InlineResponse200171', function() {
        // TODO: update the code to test InlineResponse200171
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200171);
      });
