...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200113', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200113();
      });

      it('should create an instance of InlineResponse200113', function() {
        // TODO: update the code to test InlineResponse200113
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200113);
      });
