...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LayoutGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.LayoutGroups();
      });

      it('should create an instance of LayoutGroups', function() {
        // TODO: update the code to test LayoutGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.LayoutGroups);
      });
