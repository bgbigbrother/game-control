...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20044', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20044();
      });

      it('should create an instance of InlineResponse20044', function() {
        // TODO: update the code to test InlineResponse20044
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20044);
      });
