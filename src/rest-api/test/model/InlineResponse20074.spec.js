...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20074', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20074();
      });

      it('should create an instance of InlineResponse20074', function() {
        // TODO: update the code to test InlineResponse20074
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20074);
      });
