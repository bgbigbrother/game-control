...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20039', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20039();
      });

      it('should create an instance of InlineResponse20039', function() {
        // TODO: update the code to test InlineResponse20039
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20039);
      });
