...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20040', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20040();
      });

      it('should create an instance of InlineResponse20040', function() {
        // TODO: update the code to test InlineResponse20040
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20040);
      });
