...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FailoverRecorders', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.FailoverRecorders();
      });

      it('should create an instance of FailoverRecorders', function() {
        // TODO: update the code to test FailoverRecorders
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.FailoverRecorders);
      });
      ...
      it('should have the property databasePath (base name: "databasePath")', function() {
        // TODO: update the code to test the property databasePath
        expect(instance).to.have.property('databasePath');
        // expect(instance.databasePath).to.be(expectedValueLiteral);
      });
