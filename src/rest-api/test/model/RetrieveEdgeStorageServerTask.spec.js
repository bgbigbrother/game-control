...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveEdgeStorageServerTask', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.RetrieveEdgeStorageServerTask();
      });

      it('should create an instance of RetrieveEdgeStorageServerTask', function() {
        // TODO: update the code to test RetrieveEdgeStorageServerTask
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.RetrieveEdgeStorageServerTask);
      });
