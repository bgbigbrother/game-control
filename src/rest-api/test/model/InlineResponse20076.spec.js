...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20076', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20076();
      });

      it('should create an instance of InlineResponse20076', function() {
        // TODO: update the code to test InlineResponse20076
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20076);
      });
