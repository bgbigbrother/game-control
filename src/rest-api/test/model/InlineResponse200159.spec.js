...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200159', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200159();
      });

      it('should create an instance of InlineResponse200159', function() {
        // TODO: update the code to test InlineResponse200159
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200159);
      });
