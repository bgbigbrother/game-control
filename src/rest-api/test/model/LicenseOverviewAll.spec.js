...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LicenseOverviewAll', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.LicenseOverviewAll();
      });

      it('should create an instance of LicenseOverviewAll', function() {
        // TODO: update the code to test LicenseOverviewAll
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.LicenseOverviewAll);
      });
