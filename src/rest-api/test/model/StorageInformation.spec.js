...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StorageInformation', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.StorageInformation();
      });

      it('should create an instance of StorageInformation', function() {
        // TODO: update the code to test StorageInformation
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.StorageInformation);
      });
