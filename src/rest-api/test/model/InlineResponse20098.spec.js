...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20098', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20098();
      });

      it('should create an instance of InlineResponse20098', function() {
        // TODO: update the code to test InlineResponse20098
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20098);
      });
