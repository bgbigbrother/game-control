...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20018', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20018();
      });

      it('should create an instance of InlineResponse20018', function() {
        // TODO: update the code to test InlineResponse20018
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20018);
      });
