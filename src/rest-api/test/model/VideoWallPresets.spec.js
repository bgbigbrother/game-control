...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VideoWallPresets', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.VideoWallPresets();
      });

      it('should create an instance of VideoWallPresets', function() {
        // TODO: update the code to test VideoWallPresets
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.VideoWallPresets);
      });
