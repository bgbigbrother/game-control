...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20019', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20019();
      });

      it('should create an instance of InlineResponse20019', function() {
        // TODO: update the code to test InlineResponse20019
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20019);
      });
