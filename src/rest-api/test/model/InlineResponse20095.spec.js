...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20095', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20095();
      });

      it('should create an instance of InlineResponse20095', function() {
        // TODO: update the code to test InlineResponse20095
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20095);
      });
