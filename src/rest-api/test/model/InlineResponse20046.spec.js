...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20046', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20046();
      });

      it('should create an instance of InlineResponse20046', function() {
        // TODO: update the code to test InlineResponse20046
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20046);
      });
