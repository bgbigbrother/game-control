...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20012', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20012();
      });

      it('should create an instance of InlineResponse20012', function() {
        // TODO: update the code to test InlineResponse20012
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20012);
      });
