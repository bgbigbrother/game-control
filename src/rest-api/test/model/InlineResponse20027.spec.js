...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20027', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20027();
      });

      it('should create an instance of InlineResponse20027', function() {
        // TODO: update the code to test InlineResponse20027
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20027);
      });
