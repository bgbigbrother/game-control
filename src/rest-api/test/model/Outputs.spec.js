...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Outputs', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.Outputs();
      });

      it('should create an instance of Outputs', function() {
        // TODO: update the code to test Outputs
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.Outputs);
      });
