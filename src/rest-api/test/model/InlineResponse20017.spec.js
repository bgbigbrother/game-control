...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20017', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20017();
      });

      it('should create an instance of InlineResponse20017', function() {
        // TODO: update the code to test InlineResponse20017
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20017);
      });
