...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200119', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200119();
      });

      it('should create an instance of InlineResponse200119', function() {
        // TODO: update the code to test InlineResponse200119
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse200119);
      });
