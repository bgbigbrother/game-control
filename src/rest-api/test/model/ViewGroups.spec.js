...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ViewGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.ViewGroups();
      });

      it('should create an instance of ViewGroups', function() {
        // TODO: update the code to test ViewGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.ViewGroups);
      });
