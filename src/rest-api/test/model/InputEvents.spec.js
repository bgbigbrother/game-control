...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InputEvents', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InputEvents();
      });

      it('should create an instance of InputEvents', function() {
        // TODO: update the code to test InputEvents
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InputEvents);
      });
