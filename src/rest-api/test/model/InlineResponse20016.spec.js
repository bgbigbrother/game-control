...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20016', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20016();
      });

      it('should create an instance of InlineResponse20016', function() {
        // TODO: update the code to test InlineResponse20016
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20016);
      });
