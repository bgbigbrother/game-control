...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpeakerGroups', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.SpeakerGroups();
      });

      it('should create an instance of SpeakerGroups', function() {
        // TODO: update the code to test SpeakerGroups
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.SpeakerGroups);
      });
