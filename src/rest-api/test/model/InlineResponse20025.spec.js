...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20025', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20025();
      });

      it('should create an instance of InlineResponse20025', function() {
        // TODO: update the code to test InlineResponse20025
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20025);
      });
