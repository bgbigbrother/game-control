...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20030', function() {
      beforeEach(function() {
        instance = new MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20030();
      });

      it('should create an instance of InlineResponse20030', function() {
        // TODO: update the code to test InlineResponse20030
        expect(instance).to.be.a(MilestoneIntegrationPlatformVmsResTfulApi.InlineResponse20030);
      });
